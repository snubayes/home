...
* Jaeyong Lee and Steven N. MacEachern. (2020.06) [A New Proof of the Stick-Breaking Construction of Dirichlet Processes](https://link.springer.com/article/10.1007/s42952-019-00008-w) JKSS, 49(2), 389-394.
...
* Minchul Kim and Jaeyong Lee. (2020.03). [Hamiltonian Markov Chain Monte Carlo for Multiple GPUs with Application to Bayesian Deep Neural Nets](https://link.springer.com/article/10.1007/s42952-019-00001-3) JKSS, 49(1), 139-160.
...
* Suji Lee, Sukjin Han, Sewon Park, Kyeongwon Lee, and Jaeyong Lee. (2019.04). Korean speech recognition using deep learning (in Korean). The Korean Journal of Applied Statistics, 32(2), 213-227.  
    이수지, 한석진, 박세원, 이경원과 이재용. (2019.04). [딥러닝 모형을 사용한 한국어 음성인식](https://kiss.kstudy.com/Detail/Ar?key=3677408) 응용통계연구, 32(2), 213-227.

### 2018

* Youngin Jo, Seongil Jo, Yung-Seop Lee and Jaeyong Lee. (2018). [Bayesian Temporal Density Estimation with Autoregressive Species Sampling Models](https://www.sciencedirect.com/science/article/abs/pii/S1226319218300140) Journal of Korean Statistical Society, 47(3), 248-262.
...
* Seongil Jo, Jaeyong Lee, Peter Muller, Fernando A. Quintana & Lorenzo Trippa. (2017). [Dependent Species Sampling Models for Spatial Density Estimation](https://www.dropbox.com/s/5mlm1jffs5wgoid/jo2016dependent%20species%20sampling%20models%20for%20spatial%20density%20estimation.pdf?dl=0) Bayesian Analysis, 12(2), 379-406.
...
* 황재훈, 김장석, 이영선, 이재용, 송아름, 김준규, 박지영, 양지원, 양혜민, 강승호, 오용제, 안승모, 최종택, 성춘택, David K. Wright, 최선호, 현창호. (2016). [방사선탄소연대의 고목 효과에 대한 실험적 검토](https://www.kci.go.kr/kciportal/ci/sereArticleSearch/ciSereArtiView.kci?sereArticleSearchBean.artiId=ART002112281)  한국상고사학보, 92, 117-149.
